...
public class nfs_protClient extends OncRpcClientStub {
     ...
     */
    public nfs_protClient(InetAddress host, int protocol)
                                                         throws OncRpcException,
                                                         IOException {
     ...
     *             if an I/O error occurs.
     */
    public nfs_protClient(InetAddress host, int program, int version,
    ...
    public diropres NFSPROC_CREATE_2(createargs arg1) throws OncRpcException {
        ...
        client.call(nfs_prot.NFSPROC_CREATE_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public attrstat NFSPROC_GETATTR_2(nfs_fh arg1) throws OncRpcException {
        ...
        client.call(nfs_prot.NFSPROC_GETATTR_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public diropres NFSPROC_LOOKUP_2(diropargs arg1) throws OncRpcException {
        diropres result$ = new diropres();
        client.call(nfs_prot.NFSPROC_LOOKUP_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public diropres NFSPROC_MKDIR_2(createargs arg1) throws OncRpcException {
        diropres result$ = new diropres();
        client.call(nfs_prot.NFSPROC_MKDIR_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public void NFSPROC_NULL_2() throws OncRpcException {
        ...
        client.call(nfs_prot.NFSPROC_NULL_2, nfs_prot.NFS_VERSION, args$,
                    result$);
    }
    ...
    public readres NFSPROC_READ_2(readargs arg1) throws OncRpcException {
        ...
        client.call(nfs_prot.NFSPROC_READ_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public readdirres NFSPROC_READDIR_2(readdirargs arg1)
        ...
        client.call(nfs_prot.NFSPROC_READDIR_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public int NFSPROC_REMOVE_2(diropargs arg1) throws OncRpcException {
        ...
        client.call(nfs_prot.NFSPROC_REMOVE_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
    ...
    public int NFSPROC_RENAME_2(renameargs arg1) throws OncRpcException {
        XdrInt result$ = new XdrInt();
        client.call(nfs_prot.NFSPROC_RENAME_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$.intValue();
    }
    ...
    public int NFSPROC_RMDIR_2(diropargs arg1) throws OncRpcException {
        XdrInt result$ = new XdrInt();
        client.call(nfs_prot.NFSPROC_RMDIR_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$.intValue();
    }
    ...
    public void NFSPROC_ROOT_2() throws OncRpcException {
        XdrVoid args$ = XdrVoid.XDR_VOID;
        XdrVoid result$ = XdrVoid.XDR_VOID;
        client.call(nfs_prot.NFSPROC_ROOT_2, nfs_prot.NFS_VERSION, args$,
                    result$);
    }
    ...
    public attrstat NFSPROC_SETATTR_2(sattrargs arg1) throws OncRpcException {
        attrstat result$ = new attrstat();
        client.call(nfs_prot.NFSPROC_SETATTR_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
    ...
    public statfsres NFSPROC_STATFS_2(nfs_fh arg1) throws OncRpcException {
        ...
        client.call(nfs_prot.NFSPROC_STATFS_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
     ...
     * @return Result from remote procedure call (of type nfsstat).
     * @throws OncRpcException
     *             if an ONC/RPC error occurs.) throws OncRpcException { XdrInt
    ...
    public int NFSPROC_SYMLINK_2(symlinkargs arg1) throws OncRpcException {
        XdrInt result$ = new XdrInt();
        client.call(nfs_prot.NFSPROC_SYMLINK_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$.intValue();
    }
    ...
    public attrstat NFSPROC_WRITE_2(writeargs arg1) throws OncRpcException {
        attrstat result$ = new attrstat();
        client.call(nfs_prot.NFSPROC_WRITE_2, nfs_prot.NFS_VERSION, arg1,
                    result$);
        return result$;
    }
