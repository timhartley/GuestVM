...
public class nfscookie implements XdrAble {
    ...
    public nfscookie(XdrDecodingStream xdr) throws OncRpcException, IOException {
        xdrDecode(xdr);
    }

    public void xdrDecode(XdrDecodingStream xdr) throws OncRpcException,
                                                IOException {
        value = xdr.xdrDecodeOpaque(nfs_prot.NFS_COOKIESIZE);
    }

    public void xdrEncode(XdrEncodingStream xdr) throws OncRpcException,
                                                IOException {
        xdr.xdrEncodeOpaque(value, nfs_prot.NFS_COOKIESIZE);
    }
