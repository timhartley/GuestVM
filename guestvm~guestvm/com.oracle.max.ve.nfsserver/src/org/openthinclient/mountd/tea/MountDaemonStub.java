...
/**
 */
public abstract class MountDaemonStub extends OncRpcServerStub implements
        OncRpcDispatchable {
    ...
    public MountDaemonStub(InetAddress bindAddr, int port,
                           int mountdProgramNumber) throws OncRpcException,
                                                   IOException {
        info = new OncRpcServerTransportRegistrationInfo[] { new OncRpcServerTransportRegistrationInfo(
                                                                                                       mountdProgramNumber != 0 ? mountdProgramNumber
                                                                                                                               : mount.MOUNTPROG,
                                                                                                       1), };
    ...
    public void dispatchOncRpcCall(OncRpcCallInformation call, int program,
        ...
        if (version == 1) {
            ...
            System.out.println("Failing for unavailable procedure: " + procedure + " version: " + version);
            call.failProcedureUnavailable();
        }
    }
    ...
    protected abstract fhstatus MOUNTPROC_MNT_1(InetAddress address,
                                                dirpath arg1);
