/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/XdrDynamicOpaque.java,v
...
/**
 * Instances of the class <code>XdrDynamicOpaque</code> represent
 * (de-)serializeable dynamic-size opaque values, which are especially useful in
 * cases where a result with only a single opaque value is expected from a
 * remote function call or only a single opaque value parameter needs to be
 * supplied.
 *
 * <p>
