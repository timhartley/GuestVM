/*
 * $Header: /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/XdrVoid.java,v
 ...
 * voids, which are especially useful in cases where no result is expected from
 * a remote function call or no parameters are supplied.
 *
 * <p>
...
public class XdrVoid implements XdrAble {
    ...
    /**
     * Static <code>XdrVoid</code> instance, which can be used in cases where no
     * data is to be serialized or deserialized but some ONC/RPC function
     * expects a reference to a XDR-able object.
     */
    ...
    /**
     * Encodes -- that is: serializes -- a void into a XDR stream in compliance
     * to RFC 1832.
     *
     * @throws OncRpcException
     *             if an ONC/RPC error occurs.
