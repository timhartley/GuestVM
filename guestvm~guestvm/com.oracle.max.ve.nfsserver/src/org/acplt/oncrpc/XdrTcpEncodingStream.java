...
public class XdrTcpEncodingStream extends XdrEncodingStream {
    ...
    /**
     * The buffer which will be filled from the datagram socket and then be used
     * to supply the information when decoding data.
     */
    private byte[] buffer;
    ...
    /**
     * The streaming socket to be used when receiving this XDR stream's buffer
     * contents.
     */
     ...
     * @param bufferSize
     *            Size of packet buffer for temporarily storing outgoing XDR
     *            data.
     */
    public XdrTcpEncodingStream(Socket streamingSocket, int bufferSize)
                                                                       throws IOException {
     ...
     * instance, to batch several ONC/RPC calls. In this case the ONC/RPC server
