/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/OncRpcClientAuth.java,v
...
/**
 * The <code>OncRpcClientAuth</code> class is the base class for handling all
 * protocol issues of ONC/RPC authentication on the client side. As it stands,
 * it does not do very much with the exception of defining the contract for the
 * behaviour of derived classes with respect to protocol handling issues.
 *
 * <p>
 * Authentication on the client side can be done as follows: just create an
 * authentication object and hand it over to the ONC/RPC client object.
 *
 * <pre>
