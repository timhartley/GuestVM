/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/XdrEncodingStream.java,v
 * 1.2 2003/08/14 13:48:33 haraldalbrecht Exp $
 *
...
/**
 * Defines the abstract base class for all encoding XDR streams. An encoding XDR
 * stream receives data in the form of Java data types and writes it to a data
 * sink (for instance, network or memory buffer) in the platform-independent XDR
 * format.
 *
 * <p>
 * Derived classes need to implement the {@link #xdrEncodeInt(int)},
 * {@link #xdrEncodeOpaque(byte[])} and
 * {@link #xdrEncodeOpaque(byte[], int, int)} methods to make this complete mess
 * workable.
 *
...
public abstract class XdrEncodingStream {
    ...
    /**
     * Encoding to use when serializing strings or <code>null</code> if the
     * system's default encoding should be used.
     */
     ...
     *
     * <p>
     * The <code>close</code> method of <code>XdrEncodingStream</code> does
     * nothing.
     *
     * @throws OncRpcException
     *             if an ONC/RPC error occurs.
    ...
    /**
     * Flushes this encoding XDR stream and forces any buffered output bytes to
     * be written out. The general contract of <code>endEncoding</code> is that
     ...
     *
     * <p>
     * The <code>endEncoding</code> method of <code>XdrEncodingStream</code>
     * does nothing.
     *
     * @throws OncRpcException
     *             if an ONC/RPC error occurs.
     ...
     *
     * @return the encoding currently used for serializing strings. If
     ...
     *            the encoding to use for serializing strings. If
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeBoolean(boolean value) throws OncRpcException,
                                                     IOException {
        xdrEncodeInt(value ? 1 : 0);
    }

    /**
     * Encodes (aka "serializes") a vector of booleans and writes it down this
     * XDR stream.
     *
     * @param value
     *            long vector to be encoded.
     * @param length
     *            of vector to write. This parameter is used as a sanity check.
     *
     * @throws OncRpcException
     *             if an ONC/RPC error occurs.
     * @throws IOException
     ...
     *             if the length of the vector does not match the specified
     *             length.
     */
    public final void xdrEncodeBooleanFixedVector(boolean[] value, int length)
        ...
        if (value.length != length) {
            throw (new IllegalArgumentException(
                                                "array size does not match protocol specification"));
        }
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeByte(byte value) throws OncRpcException,
                                               IOException {
        //
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeByteVector(byte[] value) throws OncRpcException,
                                                       IOException {
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeDouble(double value) throws OncRpcException,
                                                   IOException {
    ...
    /**
     * Encodes (aka "serializes") a XDR opaque value, which is represented by a
     * vector of byte values. The length of the opaque value is written to the
     * XDR stream, so the receiver does not need to know the exact length in
     * advance. The encoded data is always padded to be a multiple of four to
     * maintain XDR alignment.
     *
     * @param value
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeFloat(float value) throws OncRpcException,
                                                 IOException {
    ...
    /**
     * Encodes (aka "serializes") a "XDR int" value and writes it down a XDR
     ...
     *             if an I/O error occurs.
     */
    public abstract void xdrEncodeInt(int value) throws OncRpcException,
                                                IOException;
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeIntVector(int[] value) throws OncRpcException,
                                                     IOException {
        int size = value.length;
        xdrEncodeInt(size);
        for (int i = 0; i < size; i++) {
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeLong(long value) throws OncRpcException,
                                               IOException {
        //
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeLongVector(long[] value) throws OncRpcException,
                                                       IOException {
        int size = value.length;
        xdrEncodeInt(size);
        for (int i = 0; i < size; i++) {
    ...
    /**
     * Encodes (aka "serializes") a XDR opaque value, which is represented by a
     * vector of byte values. Only the opaque value is encoded, but no length
     * indication is preceeding the opaque value, so the receiver has to know
     * how long the opaque value will be. The encoded data is always padded to
     * be a multiple of four. If the length of the given byte vector is not a
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeOpaque(byte[] value) throws OncRpcException,
                                                   IOException {
    ...
    /**
     * Encodes (aka "serializes") a XDR opaque value, which is represented by a
     * vector of byte values, and starts at <code>offset</code> with a length of
     * <code>length</code>. Only the opaque value is encoded, but no length
     * indication is preceeding the opaque value, so the receiver has to know
     * how long the opaque value will be. The encoded data is always padded to
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeShort(short value) throws OncRpcException,
                                                 IOException {
        xdrEncodeInt(value);
    }
     ...
     *             if an I/O error occurs.
     */
    public final void xdrEncodeString(String value) throws OncRpcException,
                                                   IOException {
    ...
    /**
     * Encodes (aka "serializes") a vector of strings and writes it down this
     * XDR stream.
     *
     * @param value
