...
public class JrpcgenDeclaration implements Cloneable {
    ...
    /**
     * Indicates that a vector (an array) with dynamic (or unknown) size is
     * declared.
     */
    ...
    /**
     * Indicates that an indirection (reference, pointer, whatever you like to
     * call it nowadays) is declared.
     */
     ...
     *            Data type the identifier is declared of.
     * @param kind
     *            Kind of declaration (scalar, vector, indirection).
     * @param size
     *            Size of array (if fixed-sized, otherwise <code>null</code>).
     */
    public JrpcgenDeclaration(String identifier, String type, int kind,
                              String size) {
        this.identifier = identifier;
        this.type = type;
        this.kind = kind;
