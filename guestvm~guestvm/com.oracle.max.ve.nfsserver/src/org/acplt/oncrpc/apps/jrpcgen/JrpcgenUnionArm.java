/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/apps/jrpcgen/JrpcgenUnionArm
 * .java,v 1.2 2003/08/14 08:09:59 haraldalbrecht Exp $
 *
...
public class JrpcgenUnionArm {
    ...
    /**
     * Constructs a <code>JrpcgenUnionArm</code> and sets decrimated arm's value
     * and the associated attribute element.
     *
     * @param value
     *            Value for which descriminated arm is valid.
     * @param element
     *            Descriminated arm element of class {@link JrpcgenDeclaration}.
     */
