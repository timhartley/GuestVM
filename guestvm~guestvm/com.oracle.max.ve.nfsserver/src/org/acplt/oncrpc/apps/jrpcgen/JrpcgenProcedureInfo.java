/*
 * $Header:/cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/apps/jrpcgen/
 * JrpcgenProcedureInfo.java,v 1.3 2003/08/14 11:26:50 haraldalbrecht Exp $
 *
...
class JrpcgenProcedureInfo {
    ...
    /**
     * Identifier assigned to the procedure number of an a particular procedure
     * of a particular version of an ONC/RPC program.
     */
    public String procedureId;

    /**
     * Procedure number assigned to the procedure of a particular verions of an
     * ONC/RPC program. This attribute contains either an integer literal or an
     * identifier (which must resolve to an integer).
     */
     ...
     *
     * @param procedureId
     *            Identifier assigned to the procedure of a particular version
     *            of an ONC/RPC program.
     * @param procedureNumber
     *            Procedure number assigned to remote procedure.
     * @param resultType
     *            Type specifier of result returned by remote procedure.
     * @param parameters
