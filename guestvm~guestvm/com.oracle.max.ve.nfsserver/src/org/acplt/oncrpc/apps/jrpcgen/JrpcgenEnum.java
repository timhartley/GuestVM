/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/apps/jrpcgen/JrpcgenEnum
...
/**
 * The <code>JrpcgenEnum</code> class represents a single enumeration from an
 * rpcgen "x"-file. It is a "container" for the elements (constants) belonging
 * to this enumeration.
 *
...
public class JrpcgenEnum {
    ...
    /**
     * Contains enumeration elements as well as their values. The elements are
     * of class {@link JrpcgenConst}.
     */
    public Vector enums;
    ...
    /**
     * Constructs a <code>JrpcgenEnum</code> and sets the identifier and all its
     * enumeration elements.
     *
     * @param identifier
     *            Identifier to be declared.
     * @param enums
     *            Vector of enumeration elements of class {@link JrpcgenConst}.
     */
