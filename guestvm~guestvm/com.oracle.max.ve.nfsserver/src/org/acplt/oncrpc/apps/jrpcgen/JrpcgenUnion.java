/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/apps/jrpcgen/JrpcgenUnion
...
/**
 * The <code>JrpcgenUnion</code> class represents a single union defined in an
 * rpcgen "x"-file.
 *
...
public class JrpcgenUnion {
    ...
    /**
     * Contains arms of union. The arms are of class {@link JrpcgenDeclaration}.
     ...
     * @param descriminant
     *            Descriminant element of class {@link JrpcgenDeclaration}.
     * @param elements
    ...
    /**
     * Dumps the union together with its attribute elements end the descriminant
     * to <code>System.out</code>.
     */
    public void dump() {
        System.out.println("UNION " + identifier + ":");
        System.out.println("  switch (" + descriminant.type + " "
                           + descriminant.identifier + ")");
