/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/apps/jrpcgen/JrpcgenProgramInfo
 * .java,v 1.1.1.1 2003/08/13 12:03:46 haraldalbrecht Exp $
 *
...
/**
 * The <code>JrpcgenProgramInfo</code> class contains information about a single
 * ONC/RPC program as defined in an rpcgen "x"-file.
 *
 * @version $Revision: 1.1.1.1 $ $Date: 2003/08/13 12:03:46 $ $State: Exp $
 *          $Locker: $
...
class JrpcgenProgramInfo {
    ...
    /**
     * Set of versions specified for a particular ONC/RPC program. The elements
     * in the set are of class {@link JrpcgenVersionInfo}.
     */
    public Vector versions;

    /**
     * Construct a new <code>JrpcgenProgramInfo</code> object containing the
     * programs's identifier and number, as well as the versions defined for
     * this particular ONC/RPC program.
     *
     * @param programId
     *            Identifier defined for this ONC/RPC program.
     * @param programNumber
     *            Program number assigned to this ONC/RPC program.
     * @param versions
    ...
    public void dumpConstants(PrintWriter out) {
        ...
        out.println("    public final static int " + programId + " = "
                    + programNumber + ";");

        int size = versions.size();
        for (int idx = 0; idx < size; ++idx) {
            JrpcgenVersionInfo version = (JrpcgenVersionInfo) versions.elementAt(idx);
