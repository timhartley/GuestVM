...
class JrpcgenVersionInfo {
    ...
    /**
     * Set of procedures specified for a particular ONC/RPC program. The
     * elements in the set are of class {@link JrpcgenProcedureInfo}.
     */
    ...
    public void dumpConstants(PrintWriter out) {
        ...
        out.println("    public final static int " + versionId + " = "
                    + versionNumber + ";");
    }
