/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/OncRpcAuthStatus.java,v
...
/**
 * A collection of constants used to identify the authentication status (or any
 * authentication errors) in ONC/RPC replies of the corresponding ONC/RPC calls.
 *
...
public interface OncRpcAuthStatus {
    ...
    /**
     * The ONC/RPC server has rejected the credential and forces the caller to
     * begin a new session.
     */
    public static final int ONCRPC_AUTH_REJECTEDCRED = 2;

    /**
     * The ONC/RPC server detected an expired verifier (which can also happen if
