/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/web/HttpTunnelConstants
...
/**
 * A collection of constants generally useful when working with HTTP tunnels for
...
public interface HttpTunnelConstants {
    ...
    /**
     * Amount of octets (binary data) which can be encoded in a single plain
     * ASCII line. This amount must always be a <b>multiple of three</b>. This
     * is demanded by the base64 encoding scheme, which encodes every three
     * octets using four plain ASCII characters.
     */
     ...
     * setting.
     */
    public final static int ENCODED_BYTES_PER_LINE = (BYTES_PER_LINE / 3) * 4;
     ...
     */
    public final static int ENCODED_BYTES_PER_LINE_CRLF = ENCODED_BYTES_PER_LINE + 2;
