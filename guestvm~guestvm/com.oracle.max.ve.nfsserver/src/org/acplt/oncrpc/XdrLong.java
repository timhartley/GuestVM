/*
 * $Header: /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/XdrLong.java,v
 ...
 * longs (64&nbsp;bit), which are especially useful in cases where a result with
 * only a single long is expected from a remote function call or only a single
