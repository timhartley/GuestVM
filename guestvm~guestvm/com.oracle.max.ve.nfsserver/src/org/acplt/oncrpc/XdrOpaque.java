/*
 * $Header: /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/XdrOpaque.java,v
 ...
 * fixed-size opaque values, which are especially useful in cases where a result
 * with only a single opaque value is expected from a remote function call or
 * only a single opaque value parameter needs to be supplied.
 *
 * <p>
...
public class XdrOpaque implements XdrAble {
    ...
    /**
     * Constructs and initializes a new <code>XdrOpaque</code> object given only
     * the size of the opaque value.
     *
     * @param length
     *            size of opaque value.
     */
    ...
    /**
     * Returns the value of this <code>XdrOpaque</code> object as a byte vector.
     *
