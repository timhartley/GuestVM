/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/OncRpcClientStub.java,v
...
/**
 * The abstract <code>OncRpcClientStub</code> class is the base class to build
 * ONC/RPC-program specific clients upon. This class is typically only used by
 * jrpcgen generated clients, which provide a particular set of remote
...
public abstract class OncRpcClientStub {
    ...
    /**
     * The real ONC/RPC client which is responsible for handling a particular IP
     * protocol.
     */
    protected OncRpcClient client;

    /**
     * Construct a new <code>OncRpcClientStub</code> for communication with a
    ...
    public OncRpcClientStub(InetAddress host, int program, int version,
                            int port, int protocol) throws OncRpcException,
                                                   IOException {
        client = OncRpcClient.newOncRpcClient(host, program, version, port,
                                              protocol);
    }

    /**
     * Construct a new <code>OncRpcClientStub</code> which uses the given client
     * proxy object for communication with a remote ONC/RPC server.
     *
     * @param client
     *            ONC/RPC client proxy object implementing a particular IP
     *            protocol.
     */
    public OncRpcClientStub(OncRpcClient client) throws OncRpcException,
                                                IOException {
        this.client = client;
    }
    ...
    /**
     * Returns ONC/RPC client proxy object used for communication with a remote
     * ONC/RPC server.
     *
