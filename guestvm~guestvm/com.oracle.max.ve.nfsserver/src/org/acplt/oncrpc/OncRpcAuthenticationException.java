/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/OncRpcAuthenticationException
 * .java,v 1.2 2005/11/11 21:01:44 haraldalbrecht Exp $
 *
...
public class OncRpcAuthenticationException extends OncRpcException {
     ...
     * <code>OncRpcAuthenticationException</code>.
     */
    ...
    /**
     * Initializes an <code>OncRpcAuthenticationException</code> with a detail
     * of {@link OncRpcException#RPC_AUTHERROR} and the specified
     * {@link OncRpcAuthStatus authentication status} detail.
     *
     * @param authStatus
     *            The authentication status, which can be any one of the
     *            {@link OncRpcAuthStatus OncRpcAuthStatus constants}.
     */
