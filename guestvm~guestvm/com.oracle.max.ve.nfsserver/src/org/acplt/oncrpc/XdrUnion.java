 ...
 * general. Instead <code>XdrUnion</code> is an object-oriented construct which
 * helps in deploying polymorphism. For examples on how to use this, please take
 * a look at the "ACPLTea Java Library" package, which is also available from
 * <code>www.acplt.org/ks</code>. As a sidenote, the serialization scheme
 * implemented by <code>XdrUnion</code> is only a question of getting used to
 * it: after serializing the type code of the polymorphic class, the variant
