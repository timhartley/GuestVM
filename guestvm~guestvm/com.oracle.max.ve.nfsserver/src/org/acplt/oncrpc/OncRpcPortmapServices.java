/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/OncRpcPortmapServices
 * .java,v 1.1.1.1 2003/08/13 12:03:41 haraldalbrecht Exp $
 *
...
/**
 * A collection of constants used for ONC/RPC messages to identify the remote
 * procedure calls offered by ONC/RPC portmappers.
 *
...
public interface OncRpcPortmapServices {
    ...
    /**
     * Procedure number of portmap service to indirectly call a remote procedure
     * an ONC/RPC server through the ONC/RPC portmapper.
     */
    ...
    /**
     * Procedure number of portmap service to retrieve port number of a
     * particular ONC/RPC server.
     */
