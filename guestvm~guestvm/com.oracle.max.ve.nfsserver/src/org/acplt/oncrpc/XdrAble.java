/*
 * $Header: /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/XdrAble.java,v
...
/**
 * Defines the interface for all classes that should be able to be serialized
 * into XDR streams, and deserialized or constructed from XDR streams.
 *
