...
public class OncRpcClientReplyMessage extends OncRpcReplyMessage {
    ...
    /**
     * Client-side authentication protocol handling object to use when decoding
     * the reply message.
     */
        ...
        switch (replyStatus) {
            case OncRpcReplyStatus.ONCRPC_MSG_ACCEPTED:
                ...
                if (auth != null) {
                    ...
                    //
                    // If we don't have a protocol handler and the server sent
                    // its
                    // reply using another authentication scheme than AUTH_NONE,
                    // we
