...
/**
 * Defines the abstract base class for all decoding XDR streams. A decoding XDR
...
public abstract class XdrDecodingStream {
     ...
     *             if an I/O error occurs.
     */
    public final boolean[] xdrDecodeBooleanVector() throws OncRpcException,
                                                   IOException {
     ...
     *             if an I/O error occurs.
     */
    public final byte[] xdrDecodeByteVector() throws OncRpcException,
                                             IOException {
        int length = xdrDecodeInt();
        if (length > 0) {
            byte[] bytes = new byte[length];
     ...
     *             if an I/O error occurs.
     */
    public final double[] xdrDecodeDoubleVector() throws OncRpcException,
                                                 IOException {
        int length = xdrDecodeInt();
        double[] value = new double[length];
        for (int i = 0; i < length; ++i) {
    ...
    /**
     * Decodes (aka "deserializes") a XDR opaque value, which is represented by
     * a vector of byte values. The length of the opaque value to decode is
     ...
     *             if an I/O error occurs.
     */
    public final byte[] xdrDecodeDynamicOpaque() throws OncRpcException,
                                                IOException {
        int length = xdrDecodeInt();
     ...
     *             if an I/O error occurs.
     */
    public final float[] xdrDecodeFloatVector() throws OncRpcException,
                                               IOException {
        int length = xdrDecodeInt();
        float[] value = new float[length];
        for (int i = 0; i < length; ++i) {
     ...
     *             if an I/O error occurs.
     */
    public final long[] xdrDecodeLongVector() throws OncRpcException,
                                             IOException {
        int length = xdrDecodeInt();
        long[] value = new long[length];
        for (int i = 0; i < length; ++i) {
     ...
     *             if an I/O error occurs.
     */
    public final void xdrDecodeOpaque(byte[] opaque) throws OncRpcException,
                                                    IOException {
    ...
    /**
     * Decodes (aka "deserializes") a XDR opaque value, which is represented by
     * a vector of byte values, and starts at <code>offset</code> with a length
     ...
     *             if the given <code>opaque</code> byte vector isn't large
     ...
     *             if an I/O error occurs.
     */
    public abstract byte[] xdrDecodeOpaque(int length) throws OncRpcException,
                                                      IOException;
     ...
     *             if an I/O error occurs.
     */
    public final short[] xdrDecodeShortVector() throws OncRpcException,
                                               IOException {
        int length = xdrDecodeInt();
        short[] value = new short[length];
        for (int i = 0; i < length; ++i) {
    ...
    public final String xdrDecodeString() throws OncRpcException, IOException {
        ...
        if (length > 0) {
            ...
            return (characterEncoding != null) ? new String(bytes,
                                                            characterEncoding)
                                              : new String(bytes);
        } else {
            return new String();
     ...
     *             if an I/O error occurs.
     */
    public final String[] xdrDecodeStringVector() throws OncRpcException,
                                                 IOException {
        int length = xdrDecodeInt();
        String[] value = new String[length];
        for (int i = 0; i < length; ++i) {
