...
public class OncRpcUdpSocketHelper {
    ...
    /**
     * Creates a datagram socket and binds it to an arbitrary available port on
    ...
    /**
     * Looks up methods of class DatagramSocket whether they are supported by
     * the class libraries of the JRE we are currently executing on.
     */
    protected void queryMethods() {
        ...
        try {
            methodSetSendBufferSize = c.getMethod("setSendBufferSize",
                                                  new Class[] { int.class });
            methodGetSendBufferSize = c.getMethod("getSendBufferSize",
                                                  (Class[]) null);
        } catch (Exception e) {
        }
        try {
            methodSetReceiveBufferSize = c.getMethod("setReceiveBufferSize",
                                                     new Class[] { int.class });
            methodGetReceiveBufferSize = c.getMethod("getReceiveBufferSize",
                                                     (Class[]) null);
        } catch (Exception e) {
        }
    }
