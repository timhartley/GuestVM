/*
 * $Header:/cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/
 * OncRpcProgramNotRegisteredException.java,v 1.2 2005/11/11 21:03:30
 * haraldalbrecht Exp $
 *
...
/**
 * The class <code>OncRpcProgramNotRegisteredException</code> indicates that the
 * requests ONC/RPC program is not available at the specified host.
 *
...
public class OncRpcProgramNotRegisteredException extends OncRpcException {
     ...
     * <code>OncRpcProgramNotRegisteredException</code>.
     */
    private static final long serialVersionUID = 5073156463000368270L;

    /**
     * Constructs an ONC/RPC program not registered exception with a detail code
     * of <code>OncRpcException.RPC_PROGNOTREGISTERED</code> and an appropriate
     * clear-text detail message.
     */
