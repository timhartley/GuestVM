/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/server/OncRpcServerAuthUnix
...
/**
 * The <code>OncRpcServerAuthNone</code> class handles all protocol issues of
 * the ONC/RPC authentication <code>AUTH_UNIX</code> on the server side.
 *
...
public final class OncRpcServerAuthUnix extends OncRpcServerAuth {
    ...
    /**
     * Contains a set of group IDs the caller belongs to, as supplied through
     * credential.
     */
    public int[] gids;
     ...
     */
    public OncRpcServerAuthUnix(XdrDecodingStream xdr) throws OncRpcException,
                                                      IOException {
