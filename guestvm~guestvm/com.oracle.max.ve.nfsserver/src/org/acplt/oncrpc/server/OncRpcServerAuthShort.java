/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/server/OncRpcServerAuthShort
...
/**
 * The <code>OncRpcServerAuthShort</code> class handles all protocol issues of
 * the ONC/RPC authentication <code>AUTH_SHORT</code> on the server side.
 *
...
public final class OncRpcServerAuthShort extends OncRpcServerAuth {
    ...
    /**
     * Contains the shorthand authentication verifier (credential) to return to
     * the caller to be used with the next ONC/RPC calls.
     */
     ...
     *
     * @param xdr
     *            XDR stream to retrieve the object state from.
     *
     ...
     */
    public OncRpcServerAuthShort(XdrDecodingStream xdr) throws OncRpcException,
                                                       IOException {
        xdrDecodeCredVerf(xdr);
    }

    /**
     * Returns the type (flavor) of {@link OncRpcAuthType authentication} used.
     *
     ...
     * <code>null</code>, then the verifier returned to the caller will be of
     * type <code>AUTH_NONE</code>.
     */
    ...
    public final void xdrDecodeCredVerf(XdrDecodingStream xdr)
        ...
        if (shorthandCred.length > OncRpcAuthConstants.ONCRPC_MAX_AUTH_BYTES) {
    ...
    /**
     * Encodes -- that is: serializes -- an ONC/RPC authentication object (its
