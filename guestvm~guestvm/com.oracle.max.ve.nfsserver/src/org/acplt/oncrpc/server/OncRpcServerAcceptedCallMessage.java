...
public class OncRpcServerAcceptedCallMessage extends OncRpcServerReplyMessage {
    ...
    public OncRpcServerAcceptedCallMessage(OncRpcServerCallMessage call) {
        super(call, OncRpcReplyStatus.ONCRPC_MSG_ACCEPTED,
     ...
     *            matching reply message header from.
     * @param acceptStatus
     *            The accept status of the call. This can be any one of the
     *            constants defined in the {@link OncRpcAcceptStatus} interface.
     */
    public OncRpcServerAcceptedCallMessage(OncRpcServerCallMessage call,
                                           int acceptStatus) {
        super(call, OncRpcReplyStatus.ONCRPC_MSG_ACCEPTED, acceptStatus,
              OncRpcReplyMessage.UNUSED_PARAMETER,
              OncRpcReplyMessage.UNUSED_PARAMETER,
              OncRpcReplyMessage.UNUSED_PARAMETER,
              OncRpcAuthStatus.ONCRPC_AUTH_OK);
     ...
     *            matching reply message header from.
     * @param low
     *            Lowest program version supported by this ONC/RPC server.
     * @param high
    ...
    public OncRpcServerAcceptedCallMessage(OncRpcServerCallMessage call,
        ...
        super(call, OncRpcReplyStatus.ONCRPC_MSG_ACCEPTED,
              ...
              OncRpcReplyMessage.UNUSED_PARAMETER, low, high,
              OncRpcAuthStatus.ONCRPC_AUTH_OK);
    }
