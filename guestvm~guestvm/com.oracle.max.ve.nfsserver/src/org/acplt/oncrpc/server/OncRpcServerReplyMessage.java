...
public class OncRpcServerReplyMessage extends OncRpcReplyMessage {
    ...
    public OncRpcServerReplyMessage(OncRpcServerCallMessage call,
                                    int replyStatus, int acceptStatus,
                                    int rejectStatus, int lowVersion,
                                    int highVersion, int authStatus) {
        super(call, replyStatus, acceptStatus, rejectStatus, lowVersion,
        ...
        switch (replyStatus) {
            case OncRpcReplyStatus.ONCRPC_MSG_ACCEPTED:
                ...
                switch (acceptStatus) {
                    ...
                    default:
                        //
                        // Otherwise "open ended set of problem", like the
                        // author
