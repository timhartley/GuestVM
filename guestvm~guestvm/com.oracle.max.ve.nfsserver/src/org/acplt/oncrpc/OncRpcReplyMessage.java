/*
 * $Header:
 * /cvsroot/remotetea/remotetea/src/org/acplt/oncrpc/OncRpcReplyMessage.java,v
 * 1.2 2003/08/14 07:56:59 haraldalbrecht Exp $
 *
...
/**
 * The <code>OncRpcReplyMessage</code> class represents an ONC/RPC reply message
...
public abstract class OncRpcReplyMessage extends OncRpcMessage {
    ...
    /**
     * Acceptance status in case this reply was sent in response to an accepted
     * call ({@link OncRpcReplyStatus#ONCRPC_MSG_ACCEPTED}). This field can take
     * any of the values defined in the {@link OncRpcAcceptStatus} interface.
     *
     * <p>
     * Note that even for accepted calls that only in the case of
     * {@link OncRpcAcceptStatus#ONCRPC_SUCCESS} result data will follow the
     * reply message header.
     */
    public int acceptStatus;

    /**
     * Contains the reason for authentification failure in the case of
     * {@link OncRpcRejectStatus#ONCRPC_AUTH_ERROR}.
     */
    ...
    /**
     * Rejectance status in case this reply sent in response to a rejected call
     * ({@link OncRpcReplyStatus#ONCRPC_MSG_DENIED}). This field can take any of
     * the values defined in the {@link OncRpcRejectStatus} interface.
     */
     ...
     * {@link OncRpcReplyStatus#ONCRPC_MSG_DENIED}. Depending on the value of
     * this field, other fields of an instance of
     * <code>OncRpcReplyMessage</code> become important.
     *
     * <p>
     * The decision to define only one single class for the accepted and
     * rejected replies was driven by the motivation not to use polymorphism and
     * thus have to upcast and downcast references all the time.
     */
    public int replyStatus;

    /**
     * Initializes a new <code>OncRpcReplyMessage</code> object to represent an
     ...
     * @param replyStatus
     *            The reply status (see {@link OncRpcReplyStatus}).
     * @param acceptStatus
     *            The acceptance state (see {@link OncRpcAcceptStatus}).
     * @param rejectStatus
     *            The rejectance state (see {@link OncRpcRejectStatus}).
     * @param lowVersion
     *            lowest supported version.
     * @param highVersion
     *            highest supported version.
     * @param authStatus
     *            The autentication state (see {@link OncRpcAuthStatus}).
     */
    public OncRpcReplyMessage(OncRpcCallMessage call, int replyStatus,
                              int acceptStatus, int rejectStatus,
                              int lowVersion, int highVersion, int authStatus) {
