...
/**
 * There is no environment on max.ve!
 * But we certainly don't want the one that is cached in ProcessEnvironment
...
public class JDK_java_lang_ProcessEnvironment {
    ...
    private static String getenv(String key) {
        if (key.equals("JAVA_HOME")) {
            return "/maxve/image/jre";
        } else if (key.equals("USER")) {
            return "maxve";
        } else if (key.equals("HOME")) {
            return "/maxve/image/home";
