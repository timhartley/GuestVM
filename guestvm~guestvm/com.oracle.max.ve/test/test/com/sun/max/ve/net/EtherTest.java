 ...
 * Set -Dmax.ve.net.protocol.ether.Ether.debug and/or -Dmax.ve.net.protocol.ether.Ether.dump
 * to see more output.
 *
 * @author Mick Jordan
 */
...
public class EtherTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        device.registerHandler(new com.sun.max.ve.net.protocol.ether.Ether(device));
